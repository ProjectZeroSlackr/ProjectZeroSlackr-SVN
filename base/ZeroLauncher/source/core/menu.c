...
// KERIPO MOD
extern PzWindow * new_browser_window();
...
// KERIPO MOD
// Just a little customization / menu re-ordering ; )
// All the "=====" menu items are just dividers - I had to use different lengths
// and empty functions to make them all appear >_<

    pz_menu_add_stub ("/Music Player Daemon");

// Modified new ZeroLauncher menus
//    pz_menu_add_stub ("/Extras");
    pz_menu_add_stub ("/Beta Testing");
    pz_menu_add_stub ("/Custom");
    pz_menu_add_stub ("/Emulators");
    pz_menu_add_stub ("/Emulators/Non-Consoles");
    pz_menu_add_stub ("/Media");
    pz_menu_add_stub ("/Media/Games");
    pz_menu_add_stub ("/Media/Demos");
    pz_menu_add_stub ("/Tools");
    pz_menu_add_stub ("/Tools/Dev");
    pz_menu_add_stub ("/Zillae");
    pz_menu_add_stub ("/Zillae/Custom Builds");
// Just in case someone stupidly adds an old module
    pz_menu_add_stub ("/Extras");
    pz_menu_add_action ("/==================", TTK_MENU_DONOTHING);
...
*/
    ...
    pz_menu_add_setting ("/Settings/Appearance/Justification", 
    ...
    pz_menu_add_setting ("/Settings/Backlight", BACKLIGHT_TIMER, pz_global_config, backlight_options);
    pz_menu_add_setting ("/Settings/Clicker", CLICKER, pz_global_config, 0);
    pz_menu_add_action ("/Settings/Contrast", set_contrast);

    pz_menu_add_action ("/Settings/================", NULL);
    ...
    pz_menu_add_setting ("/Settings/Browser Path", BROWSER_PATH, pz_global_config, 0);
    pz_menu_add_setting ("/Settings/Browser Hidden", BROWSER_HIDDEN, pz_global_config, 0);

    pz_menu_add_action ("/Settings/=================", 0);
...
//    pz_menu_add_action ("/Power/Quit podzilla", quit_podzilla);
    pz_menu_add_action ("/Power/Quit " PZNAME, quit_podzilla);
...
TWindow *pz_menu_get() 
{
    ...
    pz_menu_add_stub ("/Settings/Advanced/About");
    pz_menu_add_stub ("/Settings/Advanced/Credits");
    ...
    pz_menu_add_action ("/Settings/==================", TTK_MENU_DONOTHING);
...
void pz_menu_sort (const char *menupath)
{
	...
	// KERIPO MOD
	// Removed since menus are hard-coded
