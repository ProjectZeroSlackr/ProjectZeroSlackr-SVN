...
{
	//ttk_menu_item * timenu = ttk_get_menu_item("/Settings/Text Input");
	//if (timenu) {
//		return ttk_mh_sub(timenu);
	//} else {
		return TTK_MENU_DONOTHING;
	//}
}
...
TWindow * new_podwrite_window_with_file(char * fn)
{
	TWindow * w;
	FILE * f;
	char * buf;
...
TWindow * podwrite_open_handler(ttk_menu_item * item)
{
