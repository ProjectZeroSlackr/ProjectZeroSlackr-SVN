...
/* $Id: mz80opc5.h,v 1.2 1999/11/08 01:33:58 nyef Exp $ */

case JR_NZ:    if(R->AF.B.l&Z_FLAG)  OpZ80_1(R); else { M_JR; } break;
case JR_NC:    if(R->AF.B.l&C_FLAG)  OpZ80_1(R); else { M_JR; } break;
case JR_Z:     if(R->AF.B.l&Z_FLAG)  { M_JR; } else OpZ80_1(R); break;
case JR_C:     if(R->AF.B.l&C_FLAG)  { M_JR; } else OpZ80_1(R); break;

case JP_NZ:    if(R->AF.B.l&Z_FLAG)  OpZ80_2(R); else { M_JP; }  break;
case JP_NC:    if(R->AF.B.l&C_FLAG)  OpZ80_2(R); else { M_JP; }  break;
case JP_PO:    if(R->AF.B.l&P_FLAG)  OpZ80_2(R); else { M_JP; }  break;
case JP_P:     if(R->AF.B.l&S_FLAG)  OpZ80_2(R); else { M_JP; }  break;
case JP_Z:     if(R->AF.B.l&Z_FLAG)  { M_JP; }  else OpZ80_2(R); break;
case JP_C:     if(R->AF.B.l&C_FLAG)  { M_JP; }  else OpZ80_2(R); break;
case JP_PE:    if(R->AF.B.l&P_FLAG)  { M_JP; }  else OpZ80_2(R); break;
case JP_M:     if(R->AF.B.l&S_FLAG)  { M_JP; }  else OpZ80_2(R); break;
...
case CALL_NZ:  if(R->AF.B.l&Z_FLAG)  OpZ80_2(R);  else { M_CALL; } break;
case CALL_NC:  if(R->AF.B.l&C_FLAG)  OpZ80_2(R);  else { M_CALL; } break;
case CALL_PO:  if(R->AF.B.l&P_FLAG)  OpZ80_2(R);  else { M_CALL; } break;
case CALL_P:   if(R->AF.B.l&S_FLAG)  OpZ80_2(R);  else { M_CALL; } break;
case CALL_Z:   if(R->AF.B.l&Z_FLAG)  { M_CALL; } else OpZ80_2(R);  break;
case CALL_C:   if(R->AF.B.l&C_FLAG)  { M_CALL; } else OpZ80_2(R);  break;
case CALL_PE:  if(R->AF.B.l&P_FLAG)  { M_CALL; } else OpZ80_2(R);  break;
case CALL_M:   if(R->AF.B.l&S_FLAG)  { M_CALL; } else OpZ80_2(R);  break;
...
case ADD_xHL:  I=RdZ80(R->XX.W+(offset)OpZ80(R));
               M_ADD(I);break;
case ADD_BYTE: I=OpZ80(R);M_ADD(I);break;
...
case SUB_xHL:  I=RdZ80(R->XX.W+(offset)OpZ80(R));
               M_SUB(I);break;
case SUB_BYTE: I=OpZ80(R);M_SUB(I);break;
...
case AND_xHL:  I=RdZ80(R->XX.W+(offset)OpZ80(R));
               M_AND(I);break;
case AND_BYTE: I=OpZ80(R);M_AND(I);break;
...
case OR_xHL:   I=RdZ80(R->XX.W+(offset)OpZ80(R));
               M_OR(I);break;
case OR_BYTE:  I=OpZ80(R);M_OR(I);break;
...
case ADC_xHL:  I=RdZ80(R->XX.W+(offset)OpZ80(R));
               M_ADC(I);break;
case ADC_BYTE: I=OpZ80(R);M_ADC(I);break;
...
case SBC_xHL:  I=RdZ80(R->XX.W+(offset)OpZ80(R));
               M_SBC(I);break;
case SBC_BYTE: I=OpZ80(R);M_SBC(I);break;
...
case XOR_xHL:  I=RdZ80(R->XX.W+(offset)OpZ80(R));
               M_XOR(I);break;
case XOR_BYTE: I=OpZ80(R);M_XOR(I);break;
...
case CP_xHL:   I=RdZ80(R->XX.W+(offset)OpZ80(R));
               M_CP(I);break;
case CP_BYTE:  I=OpZ80(R);M_CP(I);break;
...
case LD_PC_HL: R->PC.W=R->XX.W;mz80_cache_ip(R);break;
...
case DEC_xHL:  J.B.l = OpZ80(R);
               I=RdZ80(R->XX.W+(offset)J.B.l);M_DEC(I);
               WrZ80(R->XX.W+(offset)J.B.l,I);
               break;
...
case INC_xHL:  J.B.l = OpZ80(R);
               I=RdZ80(R->XX.W+(offset)J.B.l);M_INC(I);
               WrZ80(R->XX.W+(offset)J.B.l,I);
               break;
...
case DJNZ: if(--R->BC.B.h) { M_JR; } else OpZ80_1(R);break;
case JP:   M_JP;break;
case JR:   M_JR;break;
...
case NOP:  break;
case OUTA: OutZ80(OpZ80(R),R->AF.B.h);break;
case INA:  R->AF.B.h=InZ80(OpZ80(R));break;
...
case LD_xHL_B: J.W=R->XX.W+(offset)OpZ80(R);
...
case LD_xHL_C: J.W=R->XX.W+(offset)OpZ80(R);
...
case LD_xHL_D: J.W=R->XX.W+(offset)OpZ80(R);
...
case LD_xHL_E: J.W=R->XX.W+(offset)OpZ80(R);
...
case LD_xHL_H: J.W=R->XX.W+(offset)OpZ80(R);
...
case LD_xHL_L: J.W=R->XX.W+(offset)OpZ80(R);
...
case LD_xHL_A: J.W=R->XX.W+(offset)OpZ80(R);
               WrZ80(J.W,R->AF.B.h);break;

case LD_xBC_A: WrZ80(R->BC.W,R->AF.B.h);break;
case LD_xDE_A: WrZ80(R->DE.W,R->AF.B.h);break;

case LD_B_xHL:    R->BC.B.h=RdZ80(R->XX.W+(offset)OpZ80(R));break;
case LD_C_xHL:    R->BC.B.l=RdZ80(R->XX.W+(offset)OpZ80(R));break;
case LD_D_xHL:    R->DE.B.h=RdZ80(R->XX.W+(offset)OpZ80(R));break;
case LD_E_xHL:    R->DE.B.l=RdZ80(R->XX.W+(offset)OpZ80(R));break;
case LD_H_xHL:    R->HL.B.h=RdZ80(R->XX.W+(offset)OpZ80(R));break;
case LD_L_xHL:    R->HL.B.l=RdZ80(R->XX.W+(offset)OpZ80(R));break;
case LD_A_xHL:    R->AF.B.h=RdZ80(R->XX.W+(offset)OpZ80(R));break;

case LD_B_BYTE:   R->BC.B.h=OpZ80(R);break;
case LD_C_BYTE:   R->BC.B.l=OpZ80(R);break;
case LD_D_BYTE:   R->DE.B.h=OpZ80(R);break;
case LD_E_BYTE:   R->DE.B.l=OpZ80(R);break;
case LD_H_BYTE:   R->XX.B.h=OpZ80(R);break;
case LD_L_BYTE:   R->XX.B.l=OpZ80(R);break;
case LD_A_BYTE:   R->AF.B.h=OpZ80(R);break;
case LD_xHL_BYTE: J.W=R->XX.W+(offset)OpZ80(R);
                  WrZ80(J.W,OpZ80(R));break;
...
/*
 * $Log: mz80opc5.h,v $
 * Revision 1.2  1999/11/08 01:33:58  nyef
 * added preliminary implementation of ranged mmu
 *
 * Revision 1.1  1999/01/03 02:29:05  nyef
 * Initial revision
 *
 */
