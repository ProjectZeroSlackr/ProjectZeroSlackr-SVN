...
static int craps_do_draw (TWidget *wid, ttk_surface srf)
{
	 ...
	 switch(menuwin)
	 {
	   ...
	   case ROLL:
	   	 ...
	   	 if (ttk_screen->bpp != 16) { 
           /*sprintf(picDieOne, "Data/craps/%dbw.png", DieOne);
           sprintf(picDieTwo, "Data/craps/%dbw.png", DieTwo);*/
           switch(DieOne) {
           case 1: 
           sprintf(picDieOne, "Data/craps/1bw.png");
          break;
          case 2:
          sprintf(picDieOne, "Data/craps/2bw.png");
          break;
          case 3:
          sprintf(picDieOne, "Data/craps/3bw.png");
          break;
          case 4:
          sprintf(picDieOne, "Data/craps/4bw.png");
          break;
          case 5:
          sprintf(picDieOne, "Data/craps/5bw.png");
          break;
          case 6:
          sprintf(picDieOne, "Data/craps/6bw.png");
          break;
          }
          switch(DieTwo) {
           case 1: 
           sprintf(picDieTwo, "Data/craps/1bw.png");
          break;
          case 2:
          sprintf(picDieTwo, "Data/craps/2bw.png");
          break;
          case 3:
          sprintf(picDieTwo, "Data/craps/3bw.png");
          break;
          case 4:
          sprintf(picDieTwo, "Data/craps/4bw.png");
          break;
          case 5:
          sprintf(picDieTwo, "Data/craps/5bw.png");
          break;
          case 6:
          sprintf(picDieTwo, "Data/craps/6bw.png");
          break;
          }
           imgw=64, imgh=64;  }
	     else if (ttk_screen->w < 220) { 
           /*sprintf(picDieOne, "Data/craps/%ds.png", DieOne);
           sprintf(picDieTwo, "Data/craps/%ds.png", DieTwo);*/
                     switch(DieOne) {
           case 1: 
           sprintf(picDieOne, "Data/craps/1s.png");
          break;
          case 2:
          sprintf(picDieOne, "Data/craps/2s.png");
          break;
          case 3:
          sprintf(picDieOne, "Data/craps/3s.png");
          break;
          case 4:
          sprintf(picDieOne, "Data/craps/4s.png");
          break;
          case 5:
          sprintf(picDieOne, "Data/craps/5s.png");
          break;
          case 6:
          sprintf(picDieOne, "Data/craps/6s.png");
          break;
          }
          switch(DieTwo) {
           case 1: 
           sprintf(picDieTwo, "Data/craps/1s.png");
          break;
          case 2:
          sprintf(picDieTwo, "Data/craps/2s.png");
          break;
          case 3:
          sprintf(picDieTwo, "Data/craps/3s.png");
          break;
          case 4:
          sprintf(picDieTwo, "Data/craps/4s.png");
          break;
          case 5:
          sprintf(picDieTwo, "Data/craps/5s.png");
          break;
          case 6:
          sprintf(picDieTwo, "Data/craps/6s.png");
          break;
          }
           imgw=64, imgh=64; }
	     else if (ttk_screen->w >= 220) { 
           /*sprintf(picDieOne, "Data/craps/%d.png", DieOne);
           sprintf(picDieTwo, "Data/craps/%d.png", DieTwo);*/
                     switch(DieOne) {
           case 1: 
           sprintf(picDieOne, "Data/craps/1.png");
          break;
          case 2:
          sprintf(picDieOne, "Data/craps/2.png");
          break;
          case 3:
          sprintf(picDieOne, "Data/craps/3.png");
          break;
          case 4:
          sprintf(picDieOne, "Data/craps/4.png");
          break;
          case 5:
          sprintf(picDieOne, "Data/craps/5.png");
          break;
          case 6:
          sprintf(picDieOne, "Data/craps/6.png");
          break;
          }
          switch(DieTwo) {
           case 1: 
           sprintf(picDieTwo, "Data/craps/1.png");
          break;
          case 2:
          sprintf(picDieTwo, "Data/craps/2.png");
          break;
          case 3:
          sprintf(picDieTwo, "Data/craps/3.png");
          break;
          case 4:
          sprintf(picDieTwo, "Data/craps/4.png");
          break;
          case 5:
          sprintf(picDieTwo, "Data/craps/5.png");
          break;
          case 6:
          sprintf(picDieTwo, "Data/craps/6.png");
          break;
          }
           imgw=80, imgh=80; }
