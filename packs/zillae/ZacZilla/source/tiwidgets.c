...
TWindow *new_standard_text_demo_window()
{
	TWindow * ret;
	TWidget * wid;
	ret = ttk_new_window(_("Text Input Demo"));
	...
	//ret = ttk_show_window(ret);
	ti_widget_start(wid);
	ttk_show_window(ret);
}

TWindow *new_numeric_text_demo_window()
{
	TWindow * ret;
	TWidget * wid;
	ret = ttk_new_window(_("Text Input Demo"));
...
TWindow *new_password_text_demo_window()
{
	TWindow * ret;
	TWidget * wid;
	ret = ttk_new_window(_("Text Input Demo"));
...
TWindow *new_multiline_text_demo_window()
{
	TWindow * ret;
	TWidget * wid;
	ret = ttk_new_window(_("Text Input Demo"));
