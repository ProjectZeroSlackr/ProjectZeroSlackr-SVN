...
static void duckhunt_setup()
{
	...
	*///new_message_window("BIBI");
	sprintf (file, "Data/duckhunt/dog1.gif"); 
	dogw[0] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/dog2.gif"); 
	dogw[1] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/dog3.gif"); 
	dogw[2] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/dog4.gif"); 
	dogw[3] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/dog5.gif"); 
	dogw[4] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/dog6.gif"); 
	dogw[5] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/dog7.gif"); 
	dogw[6] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/dog8.gif"); 
	dogw[7] = ttk_load_image (file);
	
	
	sprintf (file, "Data/duckhunt/duck1.gif"); 
	duck[0] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/duck2.gif"); 
	duck[1] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/duck3.gif"); 
	duck[2] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/duck4.gif"); 
	duck[3] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/duck5.gif"); 
	duck[4] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/duck6.gif"); 
	duck[5] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/duck7.gif"); 
	duck[6] = ttk_load_image (file);
	sprintf (file, "Data/duckhunt/duck8.gif"); 
	duck[7] = ttk_load_image (file);
	 duckhunt_lose_bg = ttk_load_image ("Data/duckhunt/duckhunt_lose_bg.gif");
	 dog_laugh[0] = ttk_load_image ("Data/duckhunt/dog_laugh1.gif");
	 dog_laugh[1] = ttk_load_image ("Data/duckhunt/dog_laugh2.gif");
	 duckhunt_ss = ttk_load_image ("Data/duckhunt/duckhunt_ss.gif");
	 duckhunt_bg = ttk_load_image ("Data/duckhunt/duckhunt_bg.gif");
	 dead_duck = ttk_load_image ("Data/duckhunt/dead_duck.gif");
	 dog_duck = ttk_load_image ("Data/duckhunt/dog_duck.gif");
	 dd_fall = ttk_load_image ("Data/duckhunt/dd_fall.gif");
	// new_message_window("HI");
	 s_ducks[0] = ttk_load_image ("Data/duckhunt/s_duckw.gif");
	 s_ducks[1] = ttk_load_image ("Data/duckhunt/s_duckr.gif");
...
static int draw_duckhunt_highscore (TWidget *wid, ttk_surface srf) 
{
	...
	sprintf (str, "High Score = %d", readHighScore("Data/duckhunt/hs"));
...
static int event_duckhunt_highscore (TWidget *this,int button) 
{
    ...
    if (button == TTK_BUTTON_NEXT) { writeHighScore("Data/duckhunt/hs",0); this->dirty = 1;}
    return 0;
}
...
static int down_duckhunt(TWidget *this,int button)
{
      ...
      case TTK_BUTTON_HOLD:
      	 if ( score > readHighScore("Data/duckhunt/hs") )
      	  writeHighScore("Data/duckhunt/hs",score); 
