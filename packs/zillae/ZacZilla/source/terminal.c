...
static TWindow * terminal_window = 0;
...
#ifdef IPOD
#define TERMINAL_EXEC_PATH ("Data/minix-sh")
...
TWindow * new_terminal_window_with(char * path, char * argv0, char * argv1)
{
	TWindow * ret;
	TWidget * wid;
	pid_t p;
	...
	/* - - create window - - */
	terminal_window = ret = ttk_new_window(_("Terminal"));
...
TWindow * new_terminal_window(void)
{
