...
#define TEMP_FILENAME "Misc/Extract.temp"
...
int main(int argc, char *argv[])
{
   ...
   // KERIPO MOD
   //if(!fexists("/mnt/idarcnes.cfg")) {
   if(!fexists("Conf/iDarcNES.cfg")) {
 ...
 // KERIPO MOD
 //fp=fopen("/mnt/idarcnes.cfg","w");
 //fclose(fp);
 //fp=fopen("/mnt/idarcnes.cfg","w");
 fp=fopen("Conf/iDarcNES.cfg","w");
    fprintf(fp,"kb0=U\n");
    fprintf(fp,"kb1=A\n");
    fprintf(fp,"kb2=R\n");
    fprintf(fp,"kb3=S\n");
    ...
    *kb[7]=&tjoy_b;
	...
	// KERIPO MOD
	//f=fopen("/mnt/idarcnes.cfg","r");
    f=fopen("Conf/iDarcNES.cfg","r");
