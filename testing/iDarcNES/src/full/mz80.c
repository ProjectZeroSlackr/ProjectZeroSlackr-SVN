...
/* $Id: mz80.c,v 1.7 2001/02/25 21:47:47 nyef Exp $ */
...
void mz80_cache_ip(Z80 *R)
{
    ...
    if (mmu->start > R->PC.W) {
	deb_printf("mz80.c: mz80_cache_ip(): Region not in MMU.\n");
	deb_printf("    Now crashing system.\n");
    }
...
{
    (*cpu)->data.d_maratz80 = calloc(1, sizeof(Z80));
...
/*
 * $Log: mz80.c,v $
 * Revision 1.7  2001/02/25 21:47:47  nyef
 * moved mz80 CAL interface code in from cal.c
 *
 * Revision 1.6  2000/08/02 03:04:55  nyef
 * removed an outdated warning comment
 *
 * Revision 1.5  1999/11/25 16:23:17  nyef
 * fixed a couple spots that were missed when adding ranged MMU
 *
 * Revision 1.4  1999/11/08 01:33:44  nyef
 * added preliminary implementation of ranged mmu
 *
 * Revision 1.3  1999/06/06 17:45:18  nyef
 * changed memory access to be non SMS-specific
 *
 * Revision 1.2  1999/05/01 23:57:59  nyef
 * added stuff to directly access sms memory
 *
 * Revision 1.1  1999/01/03 02:23:22  nyef
 * Initial revision
 *
 */
